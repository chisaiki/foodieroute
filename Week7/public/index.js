...
function main(){
    //set origin, destination, search query, distance
    //ORIGIN = { lat: 40.7648, lng: -73.9654 }; // Hunter College
    ORIGIN = {lat: 40.753742, lng: -73.983559} //Byrant Park
    DESTINATION = { lat: 40.7505, lng: -73.9934 }; // Penn Station
    TRAVEL_MODE = google.maps.TravelMode.DRIVING;
    SEARCH_QUERY = "Pizza";
    RADIUS = 200;
    mapOptions = {
        center: ORIGIN, // Hunter College
        zoom: 15,
      };
    
    map = new google.maps.Map(document.getElementById("map"), mapOptions);  // Update: Set map globally
    search_route();
}